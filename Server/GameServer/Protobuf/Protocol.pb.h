...
// bool success = 1;
inline void CS_LOGIN::clear_success() {
  _impl_.success_ = false;
}
inline bool CS_LOGIN::_internal_success() const {
  return _impl_.success_;
}
inline bool CS_LOGIN::success() const {
  // @@protoc_insertion_point(field_get:Protocol.CS_LOGIN.success)
  return _internal_success();
}
inline void CS_LOGIN::_internal_set_success(bool value) {
  
  _impl_.success_ = value;
}
inline void CS_LOGIN::set_success(bool value) {
  _internal_set_success(value);
  // @@protoc_insertion_point(field_set:Protocol.CS_LOGIN.success)
}
...
inline ::Protocol::PlayerInfo* SC_LOGIN::mutable_players(int index) {
...
inline const ::Protocol::PlayerInfo& SC_LOGIN::_internal_players(int index) const {
  return _impl_.players_.Get(index);
}
inline const ::Protocol::PlayerInfo& SC_LOGIN::players(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.SC_LOGIN.players)
  return _internal_players(index);
}
inline ::Protocol::PlayerInfo* SC_LOGIN::_internal_add_players() {
  return _impl_.players_.Add();
}
inline ::Protocol::PlayerInfo* SC_LOGIN::add_players() {
...
inline uint64_t CS_ENTER_GAME::_internal_playerindex() const {
  return _impl_.playerindex_;
}
inline uint64_t CS_ENTER_GAME::playerindex() const {
  // @@protoc_insertion_point(field_get:Protocol.CS_ENTER_GAME.playerIndex)
  return _internal_playerindex();
}
inline void CS_ENTER_GAME::_internal_set_playerindex(uint64_t value) {
  
  _impl_.playerindex_ = value;
}
inline void CS_ENTER_GAME::set_playerindex(uint64_t value) {
