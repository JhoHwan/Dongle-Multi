...
enum : uint16
{
	PKT_CS_LOGIN = 1000,
	PKT_SC_LOGIN = 1001,
	PKT_CS_ENTER_GAME = 1002,
	PKT_SC_ENTER_GAME = 1003,
	PKT_CS_LEAVE_GAME = 1004,
	PKT_SC_LEAVE_GAME = 1005,
	PKT_SC_SPAWN = 1006,
	PKT_SC_DESPAWN = 1007,
	PKT_CS_CHAT = 1008,
	PKT_SC_CHAT = 1009,
...
public:
	static void Init()
	{
		...
		GPacketHandler[PKT_CS_LOGIN] = [](SessionRef& session, BYTE* buffer, int32 len) { return HandlePacket<Protocol::CS_LOGIN>(Handle_CS_LOGIN, session, buffer, len); };
